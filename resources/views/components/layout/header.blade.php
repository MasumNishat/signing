        ...
        <div class="flex items-center space-x-2">
                ...
                <div x-show="notificationsOpen"
                    ...
                    <div class="max-h-96 overflow-y-auto">
                        <a href="#" class="block px-4 py-3 hover:bg-dropdown-hover transition-colors border-b border-dropdown-border">
                            <p class="text-sm font-medium text-primary">Envelope awaiting signature</p>
                        ...
                        <a href="#" class="block px-4 py-3 hover:bg-dropdown-hover transition-colors">
                            <p class="text-sm font-medium text-primary">Envelope completed</p>
            ...
            <div class="relative" @click.away="userMenuOpen = false">
                ...
                <div x-show="userMenuOpen"
                    ...
                    <!-- User Info -->
                    <div class="px-4 py-3 border-b border-dropdown-border">
                        <p class="text-sm font-medium text-primary" x-text="$store.auth.user?.name || 'User'"></p>
                        <p class="text-xs text-text-secondary truncate" x-text="$store.auth.user?.email || ''"></p>
                    </div>
                    <!-- Menu Items -->
                    <div class="py-1">
                        <a href="/profile" class="block px-4 py-2 text-sm text-primary hover:bg-dropdown-hover transition-colors">
                        ...
                        <a href="/settings" class="block px-4 py-2 text-sm text-primary hover:bg-dropdown-hover transition-colors">
                            <div class="flex items-center">
                                <svg class="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <a href="/help" class="block px-4 py-2 text-sm text-primary hover:bg-dropdown-hover transition-colors">
                            <div class="flex items-center">
                                <svg class="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
