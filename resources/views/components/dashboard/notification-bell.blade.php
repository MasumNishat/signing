...
<div x-data="{
    ...
    <button @click="open = !open"
            class="relative p-2 text-text-secondary hover:text-primary hover:bg-bg-hover rounded-lg transition-colors">
    ...
    <div x-show="open"
         ...
         class="absolute right-0 mt-2 w-80 bg-primary rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 z-50">
                ...
                <div @click="markAsRead(notification.id)"
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-primary" x-text="notification.title"></p>
